...
namespace LongDay{
	namespace Colors {
		...
		// Log severity
		constexpr ImVec4 YELLOW = { 0.73f, 0.46f, 0.09f, 1.f }; // #BA7517
		constexpr ImVec4 GREEN = { 0.24f, 0.43f, 0.07f, 1.f }; // #3e7312
		constexpr ImVec4 RED  = { 0.64f, 0.18f, 0.18f, 1.f }; // #A32D2D
